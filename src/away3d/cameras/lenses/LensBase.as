package away3d.cameras.lenses
{
	...
	public class LensBase extends EventDispatcher
	{
		...
		protected var _frustumCornersS:Vector.<Number> = new Vector.<Number>(24, true);
		...
		public function get frustumCornersS():Vector.<Number>
		{
			return _frustumCornersS;
		}
		
		public function set frustumCornersS(frustumCorners:Vector.<Number>):void
		{
			_frustumCornersS = frustumCornersS;
		}
