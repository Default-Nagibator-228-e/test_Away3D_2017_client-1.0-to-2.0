package alternativa.math
{
   ...
   public class Quaternion
   {
      ...
      private static var _q:alternativa.math.Quaternion = new alternativa.math.Quaternion();
      ...
      public static function multiply(param1:alternativa.math.Quaternion, param2:alternativa.math.Quaternion, param3:alternativa.math.Quaternion) : void
      {
      ...
      public static function createFromAxisAngle(param1:Vector3, param2:Number) : alternativa.math.Quaternion
      {
         var _loc3_:alternativa.math.Quaternion = new alternativa.math.Quaternion();
         _loc3_.setFromAxisAngle(param1,param2);
         return _loc3_;
      }
      
      public static function createFromAxisAngleComponents(param1:Number, param2:Number, param3:Number, param4:Number) : alternativa.math.Quaternion
      {
         var _loc5_:alternativa.math.Quaternion = new alternativa.math.Quaternion();
         _loc5_.setFromAxisAngleComponents(param1,param2,param3,param4);
         return _loc5_;
      }
      
      public function reset(param1:Number = 1, param2:Number = 0, param3:Number = 0, param4:Number = 0) : alternativa.math.Quaternion
      {
         this.w = param1;
         this.x = param2;
         this.y = param3;
      ...
      public function normalize() : alternativa.math.Quaternion
      {
      ...
      public function prepend(param1:alternativa.math.Quaternion) : alternativa.math.Quaternion
      {
      ...
      public function append(param1:alternativa.math.Quaternion) : alternativa.math.Quaternion
      {
      ...
      public function rotateByVector(param1:Vector3) : alternativa.math.Quaternion
      {
      ...
      public function addScaledVector(param1:Vector3, param2:Number) : alternativa.math.Quaternion
      {
      ...
      public function toMatrix3(param1:Matrix3) : alternativa.math.Quaternion
      {
      ...
      public function setFromAxisAngle(param1:Vector3, param2:Number) : alternativa.math.Quaternion
      {
      ...
      public function setFromAxisAngleComponents(param1:Number, param2:Number, param3:Number, param4:Number) : alternativa.math.Quaternion
      {
      ...
      public function nlerp(param1:alternativa.math.Quaternion, param2:alternativa.math.Quaternion, param3:Number) : alternativa.math.Quaternion
      {
         ...
         else
         {
            ...
            this.w = this.w * _loc4_;
            this.x = this.x * _loc4_;
            this.y = this.y * _loc4_;
            this.z = this.z * _loc4_;
         }
         return this;
      }
      
      public function subtract(param1:alternativa.math.Quaternion) : alternativa.math.Quaternion
      {
      ...
      public function diff(param1:alternativa.math.Quaternion, param2:alternativa.math.Quaternion) : alternativa.math.Quaternion
      {
      ...
      public function copy(param1:alternativa.math.Quaternion) : alternativa.math.Quaternion
      {
         this.w = param1.w;
         this.x = param1.x;
         this.y = param1.y;
      ...
      public function clone() : alternativa.math.Quaternion
      {
         return new alternativa.math.Quaternion(this.w,this.x,this.y,this.z);
      }
      ...
      public function slerp(param1:alternativa.math.Quaternion, param2:alternativa.math.Quaternion, param3:Number) : alternativa.math.Quaternion
      {
         var _loc6_:Number = NaN;
         var _loc7_:Number = NaN;
         var _loc8_:Number = NaN;
