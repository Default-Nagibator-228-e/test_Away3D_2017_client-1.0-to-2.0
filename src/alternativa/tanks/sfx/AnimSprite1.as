...
package alternativa.tanks.sfx {
	 ...
	 */
	public class AnimSprite1 extends Mesh {
		 ...
		 */
		public function AnimSprite1(width:Number, height:Number, materials:Vector.<TextureMaterial> = null, loop:Boolean = false, frame:int = 0) {
			super((new PlaneGeometry(width, height)),materials);
