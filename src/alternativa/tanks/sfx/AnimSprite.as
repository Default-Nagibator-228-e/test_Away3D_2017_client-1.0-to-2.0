...
package alternativa.tanks.sfx {
	...
	public class AnimSprite extends Sprite3D {
		 ...
		 */
		public function AnimSprite(width:Number, height:Number, materials:Vector.<TextureMaterial> = null, loop:Boolean = false, frame:int = 0) {
		 ...
		 * @private
		 */
		public function set materials(value:Vector.<TextureMaterial>):void {
			_materials = value;
			if (value != null) {
				frame = _frame;
			} else {
		...
		public function clone1():AnimSprite {
			var res:AnimSprite = new AnimSprite(1024, 128);
			res._materials = this._materials;
			res.scaleX = res.scaleY = res.scaleZ = 2;
			return res;
		}
		...
		/**
		 * @inheritDoc
		override protected function clone():ObjectContainer3D {
			var res:AnimSprite = new AnimSprite(width, height);
			//res.clonePropertiesFrom(this);
			var src:AnimSprite = this as AnimSprite;
			res._materials = src._materials;
			res._loop = src._loop;
			res._frame = src._frame;
			return res;
		}
		*/
		...
		/**
		 * @inheritDoc
		override protected function clonePropertiesFrom(source:ObjectContainer3D):void {
