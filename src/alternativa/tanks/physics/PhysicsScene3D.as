package alternativa.tanks.physics
{
	...
	import alternativa.tanks.physics.entities.CharacterEntity;
	...
	public class PhysicsScene3D extends Scene3D
	{
		...
		private var _fixedTimeStep:Number = 0.01666666666666666666666666666667; // TODO: add option to not use adaptive time step?
...
//			_physics.addRigidBody(entity.dynamicBody);
		...
		public function updatePhysics():void
		{
			...
			_deltaTime = (getTimer() - _lastTimeStep)*0.001;
