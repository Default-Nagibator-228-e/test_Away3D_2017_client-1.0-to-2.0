package alternativa.tanks.tank.weapon.sfx
{
   ...
   public class GunShotExplosion implements IGraphicEffect
   {
      ...
      public function GunShotExplosion(param1:Vector3D, param2:Camera3D, param3:AnimSprite, param4:int)
      {
         super();
