package alternativa.tanks.tank.weapon.sfx
{
   ...
   public class CrossPlaneShotEffect implements IGraphicEffect
   {
      ...
      public function CrossPlaneShotEffect(param1:Weapon, param2:Number, param3:Number, param4:Vector3D, param5:AWPRigidBody, param6:TextureMaterial, param7:Vector3D, param8:AnimSprite, param9:int, param10:Vector3D)
      {
         super();
         this.weapon = param1;
         ...
         this.turret = param5;
         this.timetoLive = 100;
         this.mesh = new CrossPlaneMesh(param2,param3,this.turret,this.weapon.tank,param7,param8,param4,param9,param10);
...
class CrossPlaneMesh extends ObjectContainer3D
{
   ...
   public function CrossPlaneMesh(param1:Number, param2:Number, param3:AWPRigidBody, param4:Tank, param5:Vector3D, param6:AnimSprite, param7:Vector3D, param8:int, param9:Vector3D)
   {
		super();
		...
		if (param7 == null)
		{
			...
			plane1.applyCentralForce(getf(param9, new Vector3D(plane25.rotationX,plane25.rotationY,plane25.rotationZ)));
		}
