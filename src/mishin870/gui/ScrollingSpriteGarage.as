package mishin870.gui {
    ...
    public class ScrollingSpriteGarage extends Sprite {
        ...
        public function ScrollingSpriteGarage(){
            this.setRect(1, 1);
            this.setAWH(1, 1);
        }
        ...
        public function setRect(_arg1:Number, _arg2:Number):void{
            scrollRect = new Rectangle(this.py, this.px, _arg1, _arg2);
        }
        public function scroll(_arg1:Number, _arg2:Number):void{
            ...
            scrollRect = new Rectangle(this.py, this.px, scrollRect.width, scrollRect.height);
        }
